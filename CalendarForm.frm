...
Public Enum EnumTheme                       'Available themes
    Cyan
    Blue
    Green
    Yellow
...
Private mDefaultDate As Date                    'default selected date
Private mFirstDayOfWeek As VbDayOfWeek
Private mFontSize As Long                       'Font size for all labels
Private mRatioToResize As Double                'Ratio to resize elements of userform. This is set by the mFontSize argument
Private mDateValue As Date                      'output
Private mShowTodayButton As Boolean             'Today button
Private mShowOKButton As Boolean                'OK button
Private mShowWeekNumber As Boolean              'Week number label
Private mShowDateBorder As Boolean              'borders
Private mSpecialEffects As fmSpecialEffect
Private mDateOut As Date                        'The date returned from the CalendarForm


' colors
Private mBackgroundColor As Long                'Form color
Private mHeaderColor  As Long                   'Header Label color
Private mHeaderFontColor As Long                'Header Label font color
Private mSubHeaderColor As Long                 'SubHeader Label color
Private mSubHeaderFontColor As Long             'SubHeader Label font color
Private mDateColor As Long                      'Color of date label backgrounds
Private mDateFontColor As Long                  'Font color of date labels
Private mDateBorderColor As Long                'Color of the date label borders
Private mSaturdayFontColor As Long              'Font color of Saturday date labels
Private mSundayFontColor As Long                'Font color of Sunday date labels
Private mTrailingMonthFontColor As Long         'Font color of trailing month date labels
Private mDateHoverColor As Long                 'Color of date label backgrounds when hovering over
Private mDateSelectedColor As Long              'Color of selected date label background
Private mTodayFontColor As Long                 'Font color of today's date

' date range
Private mMinimumDate As Date                    'Any date before current date
Private mMaximumDate As Date                    'Any date after current date
Private mRangeOfYears As Long                   'Number of years before and after current year
Private mFirstWeekOfYear As calFirstWeekOfYear

' @props
Property Let FirstDayOfWeek(ByVal Value As VbDayOfWeek)
    mFirstDayOfWeek = Value
End Property
Property Let FontSize(ByVal Value As Long)
    mFontSize = Max(Value, 9) 'Font size cannot be below 9
    mRatioToResize = mFontSize / 9
End Property
Property Let DefaulDate(ByVal Value As Date)
    mDefaultDate = Value
End Property
Property Get DateValue() As Date
    DateValue = mDateValue
End Property
Property Let ShowTodayButton(ByVal Value As Boolean)
    mShowTodayButton = Value
End Property
Property Let ShowOKButton(ByVal Value As Boolean)
    mShowOKButton = Value
End Property
Property Let ShowWeekNumber(ByVal Value As Boolean)
    mShowWeekNumber = Value
End Property
Property Let ShowDateBorder(ByVal Value As Boolean)
    mShowDateBorder = Value
End Property
Property Let SpecialEffects(ByVal Value As fmSpecialEffect)
    mSpecialEffects = Value
End Property
Property Get DateSelection() As Date
    DateSelection = mDateOut
End Property
Property Let BackgroundColor(ByVal Value As Long)
    mBackgroundColor = Value
End Property
Property Let HeaderColor(ByVal Value As Long)
    mHeaderColor = Value
End Property
Property Let HeaderFontColor(ByVal Value As Long)
    mHeaderFontColor = Value
End Property
Property Let SubHeaderColor(ByVal Value As Long)
    mSubHeaderColor = Value
End Property
Property Let SubHeaderFontColor(ByVal Value As Long)
    mSubHeaderFontColor = Value
End Property
Property Let DateColor(ByVal Value As Long)
    mDateColor = Value
End Property
Property Let DateFontColor(ByVal Value As Long)
    mDateFontColor = Value
End Property
Property Let DateBorderColor(ByVal Value As Long)
    mDateBorderColor = Value
End Property
Property Let SaturdayFontColor(ByVal Value As Long)
    mSaturdayFontColor = Value
End Property
Property Let SundayFontColor(ByVal Value As Long)
    mSundayFontColor = Value
End Property
Property Let TrailingMonthFontColor(ByVal Value As Long)
    mTrailingMonthFontColor = Value
End Property
Property Let DateHoverColor(ByVal Value As Long)
    mDateHoverColor = Value
End Property
Property Let DateSelectedColor(ByVal Value As Long)
    mDateSelectedColor = Value
End Property
Property Let TodayFontColor(ByVal Value As Long)
    mTodayFontColor = Value
End Property
Property Let MinimumDate(ByVal Value As Date)
    mMinimumDate = Value
End Property
Property Let MaximumDate(ByVal Value As Date)
    mMaximumDate = Value
End Property
Property Let RangeOfYears(ByVal Value As Long)
    mRangeOfYears = Value
End Property
Property Let FirstWeekOfYear(ByVal Value As calFirstWeekOfYear)
    mFirstWeekOfYear = Value
End Property

' @methods
Public Sub UseTheme(ByVal Theme As EnumTheme)

    Select Case Theme
        Case EnumTheme.Blue
            mBackgroundColor = RGB(243, 249, 251)
            mHeaderColor = RGB(147, 205, 2221)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(223, 240, 245)
            mSubHeaderFontColor = RGB(31, 78, 120)
            mDateColor = RGB(255, 255, 255)
            mDateFontColor = RGB(31, 78, 120)
            mTrailingMonthFontColor = RGB(155, 194, 230)
            mDateHoverColor = RGB(223, 240, 245)
            mDateSelectedColor = RGB(202, 223, 242)
            mSaturdayFontColor = RGB(0, 176, 240)
            mSundayFontColor = RGB(0, 176, 240)
            mTodayFontColor = RGB(0, 176, 80)
        
        Case EnumTheme.Cyan
            mBackgroundColor = RGB(243, 249, 251)
            mHeaderColor = RGB(6, 178, 188)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(205, 240, 242)
            mSubHeaderFontColor = RGB(31, 78, 120)
            mDateColor = RGB(243, 249, 251)
            mDateFontColor = 0
            mTrailingMonthFontColor = RGB(155, 194, 230)
            mDateHoverColor = RGB(205, 240, 242)
            mDateSelectedColor = RGB(205, 240, 242)
            mSaturdayFontColor = RGB(6, 178, 188)
            mSundayFontColor = RGB(6, 178, 188)
            mTodayFontColor = RGB(6, 178, 188)
        
        Case EnumTheme.Green
            mBackgroundColor = RGB(242, 248, 238)
            mHeaderColor = RGB(84, 130, 53)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(226, 239, 218)
            mSubHeaderFontColor = RGB(55, 86, 35)
            mDateColor = RGB(242, 248, 238)
            mDateFontColor = RGB(55, 86, 35)
            mSaturdayFontColor = RGB(55, 86, 35)
            mSundayFontColor = RGB(55, 86, 35)
            mTrailingMonthFontColor = RGB(106, 163, 67)
            mDateHoverColor = RGB(198, 224, 180)
            mDateSelectedColor = RGB(169, 208, 142)
            mTodayFontColor = RGB(255, 0, 0)
            mSpecialEffects = fmSpecialEffectRaised
        
        Case EnumTheme.Red
            mBackgroundColor = RGB(255, 255, 255)
            mHeaderColor = RGB(250, 30, 60)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(254, 210, 216)
            mSubHeaderFontColor = RGB(31, 78, 120)
            mDateColor = RGB(255, 255, 255)
            mDateFontColor = 0
            mTrailingMonthFontColor = RGB(155, 194, 230)
            mDateHoverColor = RGB(254, 210, 216)
            mDateSelectedColor = RGB(254, 210, 216)
            mSaturdayFontColor = RGB(250, 30, 60)
            mSundayFontColor = RGB(250, 30, 60)
            mTodayFontColor = RGB(250, 30, 60)
        
        Case EnumTheme.Yellow
            mBackgroundColor = RGB(243, 249, 251)
            mHeaderColor = RGB(254, 210, 25)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(255, 246, 209)
            mSubHeaderFontColor = RGB(31, 78, 120)
            mDateColor = RGB(243, 249, 251)
            mDateFontColor = 0
            mTrailingMonthFontColor = RGB(155, 194, 230)
            mDateHoverColor = RGB(255, 246, 209)
            mDateSelectedColor = RGB(255, 246, 209)
            mSaturdayFontColor = RGB(254, 210, 25)
            mSundayFontColor = RGB(254, 210, 25)
            mTodayFontColor = RGB(254, 210, 25)
            
        Case EnumTheme.Default
            mBackgroundColor = RGB(255, 255, 255)
            mHeaderColor = RGB(238, 238, 238)
            mHeaderFontColor = RGB(0, 0, 0)
            mSubHeaderColor = RGB(250, 250, 250)
            mSubHeaderFontColor = RGB(130, 130, 130)
            mDateColor = RGB(255, 255, 255)
            mDateFontColor = RGB(0, 0, 0)
            mDateBorderColor = RGB(238, 238, 238)
            mTrailingMonthFontColor = RGB(191, 191, 191)
            mDateHoverColor = RGB(238, 238, 238)
            mDateSelectedColor = RGB(217, 217, 217)
            mSaturdayFontColor = RGB(0, 0, 0)
            mSundayFontColor = RGB(0, 0, 0)
            mTodayFontColor = RGB(0, 176, 240)
            
        Case EnumTheme.Lime
            mBackgroundColor = RGB(255, 255, 255)
            mHeaderColor = RGB(140, 192, 65)
            mHeaderFontColor = RGB(255, 255, 255)
            mSubHeaderColor = RGB(217, 217, 217)
            mSubHeaderFontColor = RGB(0, 0, 0)
            mDateColor = RGB(255, 255, 255)
            mDateFontColor = RGB(0, 0, 0)
            mTrailingMonthFontColor = RGB(155, 194, 230)
            mDateHoverColor = RGB(238, 238, 238)
...
Public Sub DrawCalendar()
    ...
    Dim cmdButtonsMaxmFontSize As Long           'Maximum font size of command buttons
    ...
    Dim PositionLeft As Long
        ...
        BorderSpacing = 6 * mRatioToResize
        ...
        cmdButtonsMaxmFontSize = 14
                
        PositionTop = -5
        PositionLeft = -5
        
        
        'Set MinDate and MaxDate. If no mMinimumDate or mMaximumDate are provided, set the
        'MinDate to 1/1/1900 and the MaxDate to 12/31/9999. If MaxDate is less than
        'MinDate, it will default to the MinDate.
        MinDate = IIf(mMinimumDate <= 0, CDate("1/1/1900"), mMinimumDate)
        MaxDate = IIf(mMaximumDate = 0, CDate("12/31/9999"), mMaximumDate)

        If MaxDate < MinDate Then MaxDate = MinDate
        
        'If today's date falls outside min/max, make sure Today button is disabled
        If Date < MinDate Or Date > MaxDate Then mShowTodayButton = False
        ...
        With bgHeader
        .Height = bgHeaderDefaultHeight * mRatioToResize
        'The header width depends on whether week numbers are visible or not
        .Width = IIf(mShowWeekNumber, 8 * (bgDateDefaultWidth * mRatioToResize) + BorderSpacing, 7 * (bgDateDefaultWidth * mRatioToResize))
        .Left = BorderSpacing
        .Top = BorderSpacing
        End With
        ...
        .Height = scrlMonthDefaultHeight * mRatioToResize
        ...
        With lblMonth
        .AutoSize = False
        .Height = lblMonthYearDefaultHeight * mRatioToResize
        .Font.Size = HeaderDefaultFontSize * mRatioToResize
        ...
        With bgDayLabels
        .Height = bgDayLabelsDefaultHeight * mRatioToResize
        ...
        With lblWk
        .Visible = mShowWeekNumber
        .AutoSize = False
        .Height = lblDateDefaultHeight * mRatioToResize
        .Font.Size = mFontSize
        .Width = bgDateDefaultWidth * mRatioToResize
        ...
        For i = 1 To 6 'Rows
            ...
            Else
                ...
                If i = 1 Then
                    .Top = bgDayLabels.Top + bgDayLabels.Height + (((bgDateDefaultHeight * mRatioToResize) - .Height) / 2)
                Else
                    .Top = Me("bgDate" & CStr(i - 1) & "1").Top + Me("bgDate" & CStr(i - 1) & "1").Height + (((bgDateDefaultHeight * mRatioToResize) - .Height) / 2)
                End If
                End With
            End If
            ...
            For j = 1 To 7
                ...
                With bgControl
                    .Height = bgDateDefaultHeight * mRatioToResize
                    .Width = bgDateDefaultWidth * mRatioToResize
                    If j = 1 Then
        ...
        Else
            ...
            With cmdOkay
                .Visible = True
                .Height = cmdButtonDefaultHeight * mRatioToResize
                If .Height > cmdButtonsMaxHeight Then .Height = cmdButtonsMaxHeight
                .Width = cmdButtonDefaultWidth * mRatioToResize
                If .Width > cmdButtonsMaxWidth Then .Width = cmdButtonsMaxWidth
                If mFontSize > cmdButtonsMaxmFontSize Then
                    .Font.Size = cmdButtonsMaxmFontSize
                Else
                    .Font.Size = mFontSize
                End If
        ...
        If mShowOKButton And mShowTodayButton Then 'Both buttons enabled.
        ...
        ElseIf mShowOKButton Then 'Only Okay button enabled
            cmdOkay.Left = (frameCalendar.Width - cmdOkay.Width) / 2
        ElseIf mShowTodayButton Then 'Only Today button enabled
        ...
        If mDefaultDate > 0 Then
            If mDefaultDate < MinDate Then
                mDefaultDate = MinDate
            ElseIf mDefaultDate > MaxDate Then
                mDefaultDate = MaxDate
            End If
            SelectedDateIn = mDefaultDate
        ...
        Else 'No mDefaultDate provided, default to today's date
        ...
        cmbYearMin = SelectedYear - mRangeOfYears
        cmbYearMax = SelectedYear + mRangeOfYears
        ...
        frameCalendar.BackColor = mBackgroundColor
        bgHeader.BackColor = mHeaderColor
        bgScrollCover.BackColor = mHeaderColor
        lblMonth.ForeColor = mHeaderFontColor
        lblYear.ForeColor = mHeaderFontColor
        lblSelection.ForeColor = mSubHeaderFontColor
        lblSelectionDate.ForeColor = mSubHeaderFontColor
        bgDayLabels.BackColor = mSubHeaderColor
        
        For i = 1 To 7
            Me("lblDay" & CStr(i)).ForeColor = mSubHeaderFontColor
        Next i
        If mShowWeekNumber Then
            lblWk.ForeColor = mSubHeaderFontColor
            
            For i = 1 To 6
                Me("lblWeek" & CStr(i)).ForeColor = mSubHeaderFontColor
                Me("lblWeek" & CStr(i)).Visible = mShowWeekNumber
            Next i
        End If
        For i = 1 To 6
            For j = 1 To 7
                With Me("bgDate" & CStr(i) & CStr(j))
                    If mShowDateBorder Then
                        .BorderStyle = fmBorderStyleSingle
                        .BorderColor = mDateBorderColor
                    End If
                    .SpecialEffect = mSpecialEffects
                End With
            Next j
        Next i
        
        'Initialize subheader day labels, based on selected first day of week
        TempDayOfWeek = mFirstDayOfWeek
        For i = 1 To 7
...
' hovered date label to the mDateHoverColor, and stores its name and original color
' to global variables.
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Private Sub HoverControl(ctrl As MSForms.Control)
    If HoverControlName <> vbNullString Then Me.Controls(HoverControlName).BackColor = HoverControlColor
    
    HoverControlName = ctrl.Name
    HoverControlColor = ctrl.BackColor
    ctrl.BackColor = mDateHoverColor
End Sub
...
Private Sub cmbMonthYearChange()
    ...
    Dim SelectedDay As Long             'Day of selected date
        ...
        'either case.
        SelectedYear = cmbYear.Value
        SelectedMonth = IIf(SelectedYear = Year(MinDate), cmbMonth.ListIndex + Month(MinDate), cmbMonth.ListIndex + 1)
...
Private Sub SetMonthCombobox(YearIn As Long, MonthIn As Long)
    ...
    Dim i As Long                       'Used for looping
        ...
        If YearIn = YearMinDate And YearIn = YearMaxDate Then
            ...
            MonthIn = IIf(MonthIn < MonthMinDate, MonthMinDate, MonthIn)
            MonthIn = IIf(MonthIn > MonthMaxDate, MonthMaxDate, MonthIn)
...
Private Sub SetMonthYear(MonthIn As Long, YearIn As Long)
    ...
    Dim CombinedLabelWidth As Double        'Combined width of both month and year labels
        ...
        ExtraSpace = 4 * mRatioToResize
        
        'Set value of comboboxes
        cmbMonth.ListIndex = IIf(YearIn = Year(MinDate), MonthIn - Month(MinDate), MonthIn - 1)
        ...
        lblMonth.Left = ((frameCalendar.Width - CombinedLabelWidth) / 2) - (ExtraSpace / 2)
        lblYear.Left = lblMonth.Left + lblMonth.Width + ExtraSpace
...
Private Sub SetDays(MonthIn As Long, YearIn As Long, Optional DayIn As Long)
    ...
    Dim j As Long                       'Used for looping
        ...
        PrevMonth = IIf(MonthIn - 1 = 0, 12, MonthIn - 1)
        NextMonth = IIf(MonthIn + 1 = 13, 1, MonthIn + 1)
        ...
        StartDayOfWeek = Weekday(DateSerial(YearIn, MonthIn, 1), mFirstDayOfWeek)
        SundayIndex = IIf(mFirstDayOfWeek = 1, 1, 9 - mFirstDayOfWeek)
        SaturdayIndex = 8 - mFirstDayOfWeek
        ...
        Today = Date
        TodayDay = IIf(YearIn = Year(Today) And MonthIn = Month(Today), Day(Today), 0)
        ...
        For i = 1 To 6 'Rows
            ...
            If StartDayOfWeek = 1 And i = 1 Then
                ...
                StartDayOfWeekDate = IIf(PrevMonth = 12, DateSerial(YearIn - 1, PrevMonth, TempCurrentDay), DateSerial(YearIn, PrevMonth, TempCurrentDay))
            ...
            Else
                ...
                Else
                    ...
                    StartDayOfWeekDate = IIf(NextMonth = 1, DateSerial(YearIn + 1, NextMonth, TempCurrentDay), DateSerial(YearIn, NextMonth, TempCurrentDay))
                    
                End If
            End If
            
            WeekNumber = DatePart("ww", StartDayOfWeekDate, mFirstDayOfWeek, mFirstWeekOfYear)
            ...
            If WeekNumber > 52 And TempCurrentDay > 25 Then
                WeekNumber = DatePart("ww", DateSerial(YearIn + 1, 1, 1), mFirstDayOfWeek, mFirstWeekOfYear)
            End If
                    ...
                    If StartDayOfWeek = 1 And i = 1 Then
                        ...
                        Else
                            ...
                            Else
                                ...
                                .ForeColor = mTrailingMonthFontColor
                                .Caption = CStr(TempCurrentDay)
                                bgControl.BackColor = mDateColor
                            End If
                        End If
                    ...
                    Else
                        ...
                        Else 'Within bounds. Enable and set colors
                            ...
                            If CurrentDay = TodayDay Then
                                .ForeColor = mTodayFontColor
                            ElseIf j = SaturdayIndex Then
                                .ForeColor = mSaturdayFontColor
                            ElseIf j = SundayIndex Then
                                .ForeColor = mSundayFontColor
                            Else
                                .ForeColor = mDateFontColor
                            End If
                            
                            'Set background color
                            bgControl.BackColor = IIf(CurrentDay = DayIn, mDateSelectedColor, mDateColor)
...
Private Function GetSelectedDay(MonthIn As Long, YearIn As Long) As Long
    ...
    If SelectedDateIn = 0 Then Exit Function
    
    If MonthIn = Month(SelectedDateIn) And YearIn = Year(SelectedDateIn) Then GetSelectedDay = Day(SelectedDateIn)
...
Private Sub UserForm_MouseMove(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Single, ByVal Y As Single)
    If Not HoverControlName = vbNullString Then Me.Controls(HoverControlName).BackColor = HoverControlColor
End Sub
...
' @move form at will
Private Sub bgHeader_MouseDown(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Single, ByVal Y As Single)
    mX = X
    mY = Y
End Sub

Private Sub bgHeader_MouseMove(ByVal Button As Integer, ByVal Shift As Integer, ByVal X As Single, ByVal Y As Single)
...
' Everything is sized based on the mRatioToResize variable. mRatioToResize is calculated
...
Private Sub UserForm_Initialize()
    ...
    mShowDateBorder = False
    mFirstDayOfWeek = vbSunday
    mSpecialEffects = fmSpecialEffectFlat
    
    mMinimumDate = 0
    mMaximumDate = 0
    mRangeOfYears = 2
    mFirstWeekOfYear = FirstJan1
